...
export var Form = forwardRef(function (props, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { name: name, className: 'better-form', onSubmit: submitForm },
            React.createElement(FormContext.Provider, { value: passedContext }, typeof children === 'function' ? children(form) : children))));
});
Form.defaultProps = {
    name: 'better-form',
};
